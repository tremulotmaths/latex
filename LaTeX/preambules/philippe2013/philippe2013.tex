...
\usepackage{humanist} % font \hminfamily

%___________________________
%===    Créations de commandes et d'environnements
%------------------------------------------------------
\usepackage{xargs}
\usepackage{environ}
...
\newcommand\diff[1][x]{\ensuremath\mathrm{d}#1}
...
\usepackage{pas-tableur} %simulation tableur
