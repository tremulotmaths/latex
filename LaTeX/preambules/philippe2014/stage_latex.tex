...
\renewcommand\contentsname{
            \color{MarronJPT}\fontfamily{augie}\fontsize{40}{20}\selectfont \hfill Sommaire
}
...
\newcommand\NumCode{%
\refstepcounter{Code}%
Code \Roman{chapter}.\theCode\xspace
}
...
\newcommand*\pdflatex{\textsc{pdf}\LaTeX\xspace}
...
\newcommand{\NomCom}[1]{%
	\Nom@Com{#1}\index[com]{#1@\protect\texttt{\symbol{92}#1}}%
}
\makeatother
...
\newcounter{CountExo}[chapter]
\newcommand\NumExo{%
\refstepcounter{CountExo}%
\Roman{chapter}.\theCountExo\xspace
} 