\input{F:/Dropbox/Modeles_latex/Preambule_article_2012.tex}
...
%{@{\extracolsep{\fill}} |l c r|}
		\hline
		BAT 2 & \centering Contrôle de mathématiques n° 1 (durée : 55 minutes) & Année \np{2013}/\np{2014} \\
		\hline
...
%\end{center}
%\begin{center}
\textit{La qualité et la précision de la rédaction seront prises en compte dans l'appréciation des copies.\\ Faites des phrases simples et précises.\\
...
%{@{\extracolsep{\fill}} |l c r|}
		\hline
		BAT 2 & \centering Devoir maison de mathématiques n° 1 & Année \np{2013}/\np{2014} \\
		\hline
...
Lycée Jean-Pierre Timbaud \hfill Février \np{2014}
...
\psaxes[labelFontSize=\scriptstyle,xAxis=true,yAxis=true,Dx=2,Dy=2,ticksize=-2pt 0,subticks=2]{->}(0,0)(-1.95,-1.49)(8.29,6.99)
