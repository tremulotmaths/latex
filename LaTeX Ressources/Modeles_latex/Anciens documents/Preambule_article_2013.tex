...
%arbres
\usepackage{pstricks,pst-plot,pst-text,pst-tree,pstricks-add,pst-eucl,pst-all}
...
\renewcommand{\thesection}{\Roman{section}\xspace}
\renewcommand{\thesubsection}{\thesection .\Alph{subsection}\xspace} %lettres majuscules
\renewcommand{\thesubsubsection}{\thesubsection .\alph{subsubsection}\xspace} %lettres minuscules
