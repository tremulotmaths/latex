...
%\input{C:/Users/Sophie/Documents/Cours/LaTeX/preambule_2013}
%\input{C:/Users/Sophie/Documents/Cours/LaTeX/perso_dom_2013_2014}
...
\newcommand{\tete}{
	{\noindent
      \textbf{BAT 2}     	            %% Auteur
      \hfill \textbf{Année 2013-2014}   \\  	            	%% Année
	}
	%{\noindent
...
%Pour utiliser cette présentation, décommenter la ligne
%\thispagestyle{garde}
%située après le \begin{document}
...
\hline 
\textbf{\large CONTR\^OLE DE MATH\'EMATIQUES N°1} \tabularnewline 
\textit{Vendredi 04 octobre} \tabularnewline
\hline
\end{tabularx}}
...
%{@{\extracolsep{\fill}} |l c r|}
		\hline
		BAT 2 & \centering Devoir maison de mathématiques n° 1 & Année 2013/2014 \\
		\hline
...
\begin{pspicture}(2,2)
	\psbarcode{http://www.tremulotmaths.fr}{eclevel=L}{qrcode}
\end{pspicture}
\end{minipage}
...
\thispagestyle{garde} %à décommenter pour avoir l'entête des contrôles
%\dm 		%entête DM
%\enlargethispage{2cm}
...
\pagestyle{fancy}
\fancyhf{}
\pieddepage{BAT 2 - Nombres complexes}{\thepage / \pageref{LastPage}}{Année 2013-2014}
