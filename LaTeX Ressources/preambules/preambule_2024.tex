...
\newcommand{\mes}{Maths dans l'Enseignement Scientifique}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Autre package puissant pour les tableaux
...
%%%%%%%%%%%%
% encadré contrôle/interro/sujet/correction
\newcommand{\controle}{
\thispagestyle{garde_controle}

\ifenoncecadre %si énoncé -> cadre
\begin{Cadre}
...
\begin{center}
\smallskip
\ifcontrole %si contrôle
{\Large \textbf{CONTR\^OLE DE \matiere\ N\degres \numero}}\\[0.5em]
\normalsize\textit{\jour}
\else %sinon interro
{\large \textbf{INTERROGATION DE \matiere\ N\degres \numero}}\\[0.5em]
\normalsize\textit{\jour}
\fi %fin sinon interro
\smallskip
\end{center}
\end{minipage}
\hfill
...
\begin{tabular}{m{0.15\linewidth}|m{0.13\linewidth}|m{0.67\linewidth}}
\textbf{Note globale}\par
\hspace*{1em}\par
\hspace*{1em}\par
\hspace*{1em}\par
\hspace*{1em}
...
Ex 5 : ....../\exocinq
&
Réussite aux questions d'applications directes : .........\%\par\vspace*{0.5em}
Réussite aux questions de réflexion : .........\%\par\vspace*{0.5em}
Réussite aux autres questions : .........\%\par\vspace*{0.5em}
Questions abordées : .........\%
\end{tabular}
...
\smallskip
\ifcontrole %si contrôle
{\Large \textbf{CONTR\^OLE DE MATH\'EMATIQUES N\degres \numero}}\\
{\fontfamily{pzc}
\bfseries\fontsize{20}{20}\selectfont{Correction}}
\else %sinon interro
{\large\textbf{INTERROGATION DE MATH\'EMATIQUES N\degres \numero}}\\
{\fontfamily{pzc}
\bfseries\fontsize{20}{20}\selectfont{Correction}}
\fi %fin sinon interro
\smallskip
...
\end{minipage}
\end{Cadre}
\fi %fin sinon correction

\ifenoncecadre %si énoncé cadre
\begin{center}
\begin{minipage}{0.8\linewidth}
\begin{center}
\recommandations %message sous l'encadré
\end{center}
\end{minipage}
\end{center}
\fi %fin si énoncé cadre
...
\newcommand{\pearltrees}{\raisebox{-0.5em}{\includegraphics[scale=0.08]{pearltrees}}\,}

\newcommand{\capytale}{\raisebox{-0.4em}{\includegraphics[scale=0.2]{capytale}}\,}
...
%}
\newcommand{\videoyoutube}[1]{\faYoutube\ \url{#1}}

\newcommand{\verslebac}[1]{\textcolor{blue}{\faUserGraduate\  Vers le BAC \faUserGraduate\  : }#1}

\newcommand{\verslesup}[1]{\textcolor{blue}{\faPlaneDeparture\  Vers le supérieur \faPlaneDeparture\ : }#1}

\newcommand{\versmathscomp}[1]{\textcolor{blue}{\faPlaneDeparture\  Vers l'option Maths complémentaires \faPlaneDeparture\ : }#1}

\newcommand{\inenglish}[1]{\raisebox{-2.5pt}{\includegraphics[scale=0.12]{english}}\  In English \raisebox{-2.5pt}{\includegraphics[scale=0.12]{english}}\ : #1}
...
\newcommand{\spreadsheet}{\raisebox{-0.5em}{\includegraphics[scale=0.2]{stats}}\,}
