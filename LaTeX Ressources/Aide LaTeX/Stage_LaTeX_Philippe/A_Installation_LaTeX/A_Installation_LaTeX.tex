...
\newcommand{\latexinstal}[2][0.5]{\[\includegraphics[width=#1\linewidth]{img/texlive/#2}\]}
\newcommand{\texstudioimg}[2][0.5]{\[\includegraphics[width=#1\linewidth]{img/texstudio/#2}\]}

\begin{document}
\TitreFiche{Installation de LaTeX}{\small Notice}
\thispagestyle{empty}
\entete{}{Installation de \LaTeX}{}
\RegleEntete
\pieddepage{\footnotesize Philippe \sc{De Sousa}}{\small -- \thepage/\pageref{TotPages} --}{\footnotesize Lycée J.-P. \bsc{Timbaud}}

\raisebox{-5pt}{\includegraphics{bc-attention}}\ {\bfseries La procédure suivante s'applique uniquement à une installation \sffamily{Windows}.}\par
...
\begin{Verbatim}[label={[Premier test]{\sffamily Code 1}},gobble=0]
