...
\foreach \a/\b/\e/\n/\c in %angle a, angle b, effectif e, node n, couleur c
{
0/10/1/Allemand/10, 
10/270/26/Anglais/30, 
270/280/1/Arabe/50, 
280/360/8/Espagnol/80
}
{
\fill[color=black!\c!blue!\c](0,0)--(\a:5)arc(\a:\b:5)--cycle;
\draw ({(\a+\b)/2}:4) node {\e};
\draw ({(\a+\b)/2}:7) node {\n};
}
...
%1ère série
\foreach \a/\b/\e/\c in %angle a, angle b, effectif e, couleur c
{
0/18/1/10, %secteur angulaire entre 0° et 10°, effectif 5 affiché
18/324/17/30, 
324/342/1/50, 
342/360/1/80
}
{
\fill[color=black!\c!blue!\c](0,0)--(\a:\r)arc(\a:\b:\r)--cycle;
...
{
\fill[color=black!\c!red!\c](\a:\r)--(\a:\R)arc(\a:\b:\R)--(\b:\r)arc(\b:\a:\r);
